...
**Date**: [Date and time] **Attendees**: [List] **Project**:
<mention-page url="...">Project Page</mention-page>

## Executive Summary

**Status**: 🟢 On Track / 🟡 At Risk / 🔴 Behind

**Progress**: [Percentage] complete **Timeline**: [Status vs original plan]
...
**Date**: [Date] **Focus**: [What next meeting will cover]
```
