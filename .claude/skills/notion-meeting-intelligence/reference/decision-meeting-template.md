...
**Date & Time**: [Date and time] **Duration**: [Length] **Attendees**: [List of
attendees with roles] **Location**: [Physical location or video link]
**Facilitator**: [Name]
...
**Cost/Effort**: [Estimate] **Risk**: [Risk assessment]
...
**Description**: What happens if we don't decide **Implications**:
[Consequences]
...
**Selected Option**: [Option chosen] **Rationale**: [Why] **Owner**: [Who will
implement] **Timeline**: [When]
...
**Next review**: [Date] **Success metrics**: [How we'll know this worked]
```
