...
- **Executive Summary**: Strong quarter, missed revenue by 4% but exceeded
  customer growth
...
**Internal Pre-Read**: Comprehensive context with honest assessment **Executive
Agenda**: Structured 90-min presentation **Both in Notion** with links to
supporting data
