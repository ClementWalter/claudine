...
- **Top Backlog Items**: User auth improvements, API performance, mobile
  responsive fixes
...
**Internal Pre-Read**: Team context, capacity, blockers **External Agenda**:
Meeting structure, discussion topics **Both saved to Notion** and linked to
project pages
