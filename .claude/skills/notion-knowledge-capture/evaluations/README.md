...
Evaluation scenarios for testing the Knowledge Capture skill across different
Codex models.
...
- Correctly identifies content types (how-to guides, FAQs, decision records,
  wikis)
...
- Structures with proper sections (Overview, Prerequisites, Steps,
  Troubleshooting)
...
- Follows decision record structure (Context, Decision, Alternatives,
  Consequences)
...
- Correctly identifies appropriate content type (how-to, FAQ, decision record,
  wiki page)
...
1. **Use realistic conversation content** - Include actual technical details,
   decisions, or processes
2. **Test different content types** - How-to guides, FAQs, decision records,
...
5. **Include edge cases** - Unclear content types, minimal context, overlapping
   categories
