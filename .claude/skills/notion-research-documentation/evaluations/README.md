...
Evaluation scenarios for testing the Research & Documentation skill across
...
5. Verify appropriate format is selected (Research Summary, Comprehensive
   Report, Quick Brief, Comparison)
...
1. **Test different research types** - Product research, competitive analysis,
   technical investigation, market research
...
- "Uses Research Summary format with sections: Executive Summary → Key Findings
  → Details → Recommendations → Sources"
